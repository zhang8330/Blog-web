      ...
      <div class="content-area" ref="contentArea">
        ...
        >
          ...
          >
            ...
            >
              <el-avatar :size="40" :src="msgItem.myAvatar" style="display: block;"></el-avatar>
              <span style="font-size: 12px;margin-left: -10px;">{{ msgItem.userName }}</span>
            </div>
            <el-card
                class="box-card"
                style="margin: 0 10px;"
  ...
  watch: {
    userData: {
      handler() {
        ...
        this.message.myAvatar = this.userData.myAvatar;
      },
      immediate: true
    }
  },
