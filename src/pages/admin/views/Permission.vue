...
export default {
  ...
  methods:{
    switchApproved(userItem){
      ...
      this.$confirm("此操作将改变此用户的权限,后续影响较大，请问是否继续","警告",{
        confirmButtonText:"确认此操作",
    ...
    getUserList() {
      userService.getAllUserList(this.searchUserParams).then(rs => {
